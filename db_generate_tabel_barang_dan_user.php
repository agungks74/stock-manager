        ...
        <div class="row">
            <div class="col-12 py-4 mx-auto text-center">
                    ...
                    <?php
                        ...
                        try {
                            ...
                            if ($mysqli->error) {
                                ...
                                echo "<li>Tabel 'barang' berhasil di isi ".$mysqli->affected_rows."baris data</li>";
                            };
                ...
                <p class="lead">Database berhasil dibuat, silahkan <a href="login.php">
                    ...
                    <br>Atau <a href="register_user.php">Register</a> untuk membuat user baru
                </p>
                <?php
                        } catch (Exception $e) {                    
                            echo "<p>Koneksi / Query bermasalah: ".$e->getMessage()." (".$e->getCode().")</p>";
                        } finally {
                            if (isset($mysqli)) {
                                $mysqli->close();
                            }
